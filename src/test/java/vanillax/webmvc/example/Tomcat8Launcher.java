...
//              File base = new File(System.getProperty("java.io.tmpdir"));
                ...
                docBase = base.getCanonicalPath();
            }
//        rootContext = tomcat.addContext(contextPath, docBase);
            rootContext = tomcat.addWebapp(contextPath, docBase);
            rootContext.setAllowCasualMultipartParsing(true);
            tomcat.getConnector().setMaxPostSize(-1);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
